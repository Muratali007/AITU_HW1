                            ...
                            <div class="container_login">
                                ...
                                <form action="{{route('auth.save')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="fname" placeholder="Enter full first name" value="{{old('fname')}}">
                                        <span class="text-danger">@error('fname'){{$message}} @enderror</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Second name</label>
                                        <input type="text" class="form-control" name="lname" placeholder="Enter full second name" value="{{old('lname')}}">
