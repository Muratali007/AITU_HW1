...
<div class="container1">
    <div class="row">
        <div class="col">
            <h2>Youtube (video) links related to the Topic</h2>
        ...
        <div class="col">
            <img src="image/unnamed.png" style="width:40%;margin-left:100px;"></img>
        </div>
    </div>
</div>
    ...
    <footer class="bg-light text-center text-lg-start">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                ...
                <p class="par">
                    <a href="#" style="text-decoration: none;"><i class="fab fa-instagram fa-3x" style="margin-right:30px;margin-left:100px;"></i></a>
                    <a href="#" style="text-decoration: none;"><i class="fab fa-telegram-plane fa-3x" style="margin-right: 30px;"></i></a>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
<script src="\java\java2.js" charset="utf-8"></script>
</body>
</html>
